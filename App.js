...
const PaginaInicial = () => {
  return (
    <View style={styles.pagina}>
      <Image 
        source={{uri:'https://avatars.githubusercontent.com/u/142425041?v=4'}}
        style ={styles.image}
      />
      <Text style={styles.name}>Felipe Emanoel</Text>
      <Text style={styles.description}>
        Olá! 👋 Meu nome é Felipe Emanoel e sou um entusiasta da tecnologia apaixonado por criar experiências incríveis na web.
        Sou especializado em desenvolvimento Front-end, mas minha curiosidade me leva a explorar outras áreas,
        como back-end e desenvolvimento de software em geral.
      </Text>
      <Text style ={styles.description}>📫 Como chegar até mim: felipe.emanoeljkk@gmail.com</Text>
    </View>
  );
};
...
const Pagina1 = () => {
  return (
    ...
    <View style={styles.additionalContent}>
      ...
      <Text style={styles.link} onPress={()=> Linking.openURL('https://github.com/PhYllipepdm/API_Node_Mongodb')}>API de Produtos - Operações CRUD:</Text>
      <Text style={styles.projectDescription}>
        Este projeto é uma API desenvolvida em Node.js com o framework Express e MongoDB, que permite realizar operações CRUD em uma entidade de produtos. Com esta API,
         ...
         <Text style={styles.link} onPress={()=> Linking.openURL('https://github.com/PhYllipepdm/CRUD')}>CRUD - Cadastro de Funcionários</Text>
        <Text style={styles.projectDescription}>Este projeto é uma aplicação web que permite realizar o cadastro, leitura, atualização e exclusão de funcionários.
         Utiliza HTML, CSS e JavaScript para criar uma interface de usuário intuitiva e funcional.</Text>
